    ...
    for satellite_id, config in satellites.items():
        try:
            ...
            if satellite_id == "himawari":
                # Himawari structure: get_data/himawari_test_data/data/himawari_l3c/png/
                png_dir = base_path / "get_data" / "himawari_test_data" / "data" / "himawari_l3c" / "png"
                if png_dir.exists():
                ...
                # Sentinel structure: get_data/saternal3/data/eumetview_sentinel3/satellite/parameter/png/
                for param_id in config.get("parameters", {}):
                    png_dir = base_path / "get_data" / "saternal3" / "data" / "eumetview_sentinel3" / satellite_id / param_id / "png"
                    if png_dir.exists():
